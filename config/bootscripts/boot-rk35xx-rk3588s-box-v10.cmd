...
# This board's vendor U-Boot environment can retain a fallback fdtfile (for example
# rk3588-evb.dtb) even after importing /boot/armbianEnv.txt. Force the Armbian board DTB
# here so the generated image does not depend on post-build image patching.
setenv fdtfile rockchip/rk3588s-box-v10.dtb
